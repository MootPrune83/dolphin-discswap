Refer to [https://github.com/MootPrune83/dolphin-discswap/tree/master/M5StackController]([url](https://github.com/MootPrune83/dolphin-discswap/tree/master/M5StackController)) for instructions on setting up the associated (optional) disc controller.
